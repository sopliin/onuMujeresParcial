    ...
    <body>
        <div class="container mt-4">
            ...
            <%
                ...
                if (distritos != null) {
            %>
            <form action="<%= request.getContextPath() %>/EncuestadorServlett" method="post">
                ...
                <a href="<%= request.getContextPath() %>/EncuestadorServlett" class="btn btn-secondary">Cancelar</a>
            </form>
            <%
                } else {
                    response.sendRedirect(request.getContextPath() + "/EncuestadorServlett");
                }
            %>
        </div>
